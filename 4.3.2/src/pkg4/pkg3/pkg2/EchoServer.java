  ...
  public static void main(String[] args) throws IOException {
   ...
   while ((inputLine = in .readLine()) != null) {
       ...
       if(inputLine.contains("fun:")){
           ...
           System.out.println("miremos "+Operacion);
       ...
       //else{
        ...
        //resp= Integer.parseInt(inputLine);
        g=inputLine;
       //}


       
    //System.out.println("Mensaje:"+resp*resp);
    //outputLine = "Respuesta al cuadrado es :" + resp*resp;
